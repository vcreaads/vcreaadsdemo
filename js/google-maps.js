// Google maps pin tooltip	
	var markers = [
    	{
			...
			"description": 'Vcrea Advertising <br/> Vettichira Road <br/> Kadampuzha <br/> Malappuram <br/>Kerala'
        }
	];
	...
	// Google maps style	
           	styles: [{"featureType":"water","elementType":"geometry","stylers":[{"color":"#00aa85"},
